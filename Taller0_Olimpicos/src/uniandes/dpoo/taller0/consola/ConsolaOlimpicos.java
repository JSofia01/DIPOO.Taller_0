...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pa�s de un atleta determinado");
	...
	/**
	 * Este m�todo le pide al usuario el nombre de un atleta. A continuaci�n,
	 * le muestra el nombre del pa�s al cual representa el atleta.
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "Pa�s de un atleta determinado" + "\n");

		String nombre = input("Por favor ingrese el nombre de un atleta");
		Pais pais = calculadora.buscarPaisAtleta(nombre);
		if(pais != null)
		{
			System.out.println("El atleta est� representando al pa�s: " + pais);
		}
		else
		{
			System.out.println("El atleta ingresado no se encuentra dentro de los datos cargados");
		}
	}
