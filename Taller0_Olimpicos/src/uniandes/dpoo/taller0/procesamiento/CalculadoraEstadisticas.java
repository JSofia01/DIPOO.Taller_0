...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Consulta el pa�s de un atleta determinado.
	 * 
	 * @param El nombre de un atleta.
	 * @return El pa�s del atleta dado por par�metro.
	 */
	public Pais buscarPaisAtleta(String nombreAtletaD)
	{
		Pais pais = null;
		Atleta AtletaD = buscarAtleta(nombreAtletaD);
		if (AtletaD != null)
		{
			pais = AtletaD.darPais();
		}
		else
		{
			pais = null;
